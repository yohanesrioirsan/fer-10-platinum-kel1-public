...
import { Button, Card, Col, Container, Form, FormGroup, FormLabel, FormSelect, Row } from "react-bootstrap";
import { useRouter } from "next/router";

function SearchForm({ nameValue = "", categoryValue = "", priceValue = 0, statusValue = "" }) {
    ...
    const handleSubmit = (evt) => {
        ...
        router.push(`/result?name=${name}&category=${category}&harga=${price}&status=${status}`);
    };
                    ...
                    <Row>
                        ...
                        <Col lg={3} sm={12}>
                            <FormGroup>
                                ...
                                <FormSelect defaultValue={String(priceValue)} className="search-input" onChange={(e) => setPrice(e.target.value)}>
