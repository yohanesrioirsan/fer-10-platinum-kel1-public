...
import { Form, Button, Container, Row, Col, Alert, Navbar } from "react-bootstrap";
                    ...
                    <div>
                        ...
                        <Navbar bg="light">
                            <Navbar.Brand href="#home">
                                <Image src={logobcr} className="d-inline-block align-top" alt="logo" />
                            </Navbar.Brand>
                        </Navbar>
                        ...
                        <div className="mt-4 text-center">
                            Don`t have an account? <div style={{ textDecoration: "underline" }}>Sign Up for free</div>
                        </div>
                    </div>
                </Col>
